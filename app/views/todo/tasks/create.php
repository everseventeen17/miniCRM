...
<div class="container" id="create-category-form">
    <form method="POST" action="/todo/tasks/store" class="form">
        ...
        <div class="form-group mt-1">
            ...
            <input  class="form-control" id="form_text_0" name="title" placeholder="Enter task title" required minlength="2" maxlength="30">
            <span class="span__error span__error_title">1</span>
        </div>
        <div class="form-group mt-1">
            <label>Finish date</label>
            <input  class="form-control" id="form_text_1" name="finish_date" placeholder="Enter finish date" type="datetime-local" required>
            <span class="span__error span__error_finish_date">1</span>
        </div>
        <div class="form-group mt-1">
            <label>Task description</label>
            <textarea  class="form-control" id="form_text_2" rows="10" name="description" required minlength="2" maxlength="100"></textarea>
