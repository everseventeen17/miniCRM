...
<div class="container" id="create-role-form">
    <form method="POST" action="/roles/store" class="form">
        ...
        <div class="form-group mt-1">
            ...
            <input  class="form-control form-control-input" id="form_text_0" name="role_name" placeholder="Enter role name" required minlength="2" maxlength="30">
            <span class="span__error span__error_role_name">1</span>
        </div>
        <div class="form-group mt-1">
            <label>Role description</label>
            <textarea  class="form-control form-control-input" id="form_text_1" rows="10" name="role_description" required minlength="2" maxlength="30"></textarea>
